...
def main():
    ...
    # --- DUZELTME: User-Agent Eklendi (Sunucu engellemesin diye) ---
    headers = {
    ...
    try:
        ...
        print(f"Indirilen veri boyutu: {len(content)} karakter.")
        
        if len(content) < 100:
            print("UYARI: Indirilen dosya cok kucuk veya bos!")
    ...
    print(f"Toplam {count} kanal/icerik islendi.")
